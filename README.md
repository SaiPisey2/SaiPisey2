<h1 align="center">Hi, I'm Sai Pisey 👋</h1>

<p align="center">
  <b>Senior DevOps Engineer · MLOps · LLMOps</b><br>
  Kubestronaut (CNCF) · Running ML & LLM systems in production on Kubernetes
</p>
...
DevOps and MLOps Engineer with **4+ years** running **Machine Learning** and **Large Language Model** systems in production on **Kubernetes**, **AWS** and **Python**. I build training and inference pipelines, model serving and drift monitoring, RAG and agentic platforms — operated to **SLOs** with on-call incident response.

- 🔭 Currently: agentic AI platforms, LLM gateways, GPU scheduling and continuous training
- 🌱 Learning in public: LLMOps evaluation, vLLM serving economics, eBPF observability
- 🤝 Open to: Remote DevOps / SRE / MLOps / LLMOps / Platform Engineering roles
- ⚡ Fun fact: one of ~1,600 **Kubestronauts** worldwide (all 5 CNCF Kubernetes certs)
...
![Elastic](https://img.shields.io/badge/Elastic%20Stack-005571?style=for-the-badge&logo=elasticstack&logoColor=white)
...
Upstream fixes in CNCF and cloud-native projects:

| Project | PR | What it fixes |
|---|---|---|
| [argoproj/argo-cd](https://github.com/argoproj/argo-cd) | [#28995](https://github.com/argoproj/argo-cd/pull/28995) | Suspended `FlinkDeployment` stuck Progressing forever in the health check |
| [prometheus/node_exporter](https://github.com/prometheus/node_exporter) | [#3767](https://github.com/prometheus/node_exporter/pull/3767) | Apple Silicon: 52 thermal sensors dropped on a `kIOReturnNotFound` CPU-power probe |
| [prometheus/node_exporter](https://github.com/prometheus/node_exporter) | [#3798](https://github.com/prometheus/node_exporter/pull/3798) | `end-to-end-test.sh -u` on macOS bash 3.2 overwrote the Linux fixture |
| [prometheus-community/bind_exporter](https://github.com/prometheus-community/bind_exporter) | [#288](https://github.com/prometheus-community/bind_exporter/pull/288) | `bind_recursive_clients` typed as a counter when it is a gauge |
